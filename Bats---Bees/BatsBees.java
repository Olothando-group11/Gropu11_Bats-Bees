...
public class BatsBees extends JPanel implements ActionListener, KeyListener {
	int boardWidth = 360;
	int boardHeight = 640;
	Image backgroundImg;
	Image batImg;
	...
	BatsBees() {
		...
		batImg = new ImageIcon(getClass().getResource("bat.png")).getImage();
		topRockImg = new ImageIcon(getClass().getResource("toppipe.png")).getImage();
		bottomRockImg = new ImageIcon(getClass().getResource("bottompipe.png")).getImage();
